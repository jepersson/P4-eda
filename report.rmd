...
statistical analysis at all but since I haven't really done any analysis with 
real contemporary data like this it does feel kind of refreshing with a different 
challenge compared to the orchestrated assignments I experienced as a student.
...
Next, we also take a look at some borrower density curves for the same variables 
as above. 

```{r echo=FALSE, warning=FALSE, fig.align="center", Multivariate_Plots_2}

# Plotting facet for borrower rate histograms by income range
ggplot(loan_data) +
...
upper half of this quartile has different distributions.
...
### Plot Three
```{r echo=FALSE, warning=FALSE, fig.align="center", fig.width=5, fig.height=3, Plot_Three}
...
grid.arrange(income_plot, origination_plot, debt_plot, term_plot, 
             ncol = 2,
             top = "Loan original amount vs borrower rate for different auxillary features")
