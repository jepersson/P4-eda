...
ggplot(subset(loan_data, LoanOriginationDate < as.Date("2014-03-01") & LoanOriginationDate > as.Date("2005-12-01"))) +
  geom_histogram(aes(LoanOriginationDate), stat = "bin", bins = 100) +
  scale_y_continuous(limits = c(0, 6000),
                     breaks = seq(0, 6000, 1000))

ggplot(subset(loan_data, ClosedDate < as.Date("2014-03-01") & ClosedDate > as.Date("2005-12-01"))) +
...
the loan term probably are artificially locked at one, three or five years. We also saw that
...
somewhere around 0.2 would be very interesting and perhaps a good candidate for a
