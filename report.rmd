...
major breakthough due to this figure this time, it do show that by trying
...
origination date graph with a wierd pattern.)
...
I definetely think that going back and look at the prosper rating and a few more financial variables can result in a more in depth analysis of what drives the rating. It would also be a good canditate for creating a model to fit to the data and validate it against the already exsisting ratings which sounds like heaps of fun.
